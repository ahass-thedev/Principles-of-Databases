...
<br>
	<form method="post" action="Cust_Rep4a.jsp">
		<table>
	<tr>    
	
	<td>Reservation Number</td><td><input type="text" name="Res_No" required></td>
	</tr>
	<tr>    
	
	<td>Account_Number</td><td><input type="text" name="Account_No" required></td>
	</tr>
