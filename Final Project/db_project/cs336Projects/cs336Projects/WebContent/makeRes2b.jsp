...
<%
	try{
		...
		String str = "SELECT Fare FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
...
// FARE IS CALCULATED IN THIS REGION =========================				
		...
		str = "SELECT Advance_Purchase FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
...
// ===========================================================
		...
		str = "SELECT depAirID FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
		resultString = stmt.executeQuery(str);
		resultString.next();
		...
		str = "SELECT depTime FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
		resultString = stmt.executeQuery(str);
		resultString.next();
		...
		str = "SELECT arrAirID FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
		resultString = stmt.executeQuery(str);
		resultString.next();
		...
		str = "SELECT arrDate FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
		resultString = stmt.executeQuery(str);
		resultString.next();
		...
		str = "SELECT arrTime FROM Flight WHERE Airline_ID = '"+airID+"' AND Flight_No = '"+flightID+"' AND depDate = '"+ retDate+"'";
		//Run the query against the database.
		resultString = stmt.executeQuery(str);
		resultString.next();
		...
		//Create a Prepared SQL statement allowing you to introduce the parameters of the query
			...
			out.println(" Departing from: "+ depAirID+ " at "+depTime+" on "+retDate+" | ");	
