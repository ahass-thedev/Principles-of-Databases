...
<br>	
	...
	try {
		...
		String origin = request.getParameter("originF");
		String destination = request.getParameter("destinationF");
		String departDateStart = request.getParameter("departDateFS");
		String departDateEnd = request.getParameter("departDateFE");
		

		String str = "SELECT * FROM Flight WHERE depAirID ='" + origin +"' AND arrAirID ='"+destination+"' AND depDate >='"+departDateStart+"' AND depDate <='" + departDateEnd + "'";
...
<!-- 	<form method="post" action="fly1.jsp">
		<input type="submit" value="Back">
	</form> -->

	<a href="Logout.jsp" class="login100-form-btn wrap-input100 m-b-16" style="width:350px">Logout</a>

<a href="fly4.jsp"class="login100-form-btn wrap-input100 m-b-16"style="width:350px">Back</a>
</div>