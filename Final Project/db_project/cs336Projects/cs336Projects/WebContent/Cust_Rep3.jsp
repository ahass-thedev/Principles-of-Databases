...
Add a Airport:
<br>
	<form method="post" action="Cust_Rep3a.jsp">
	<table>
	<tr>    
	<td>Airport_ID(I.E XXX)</td><td><input type="text" name="Airport_ID" maxlength=3 required></td>
	</tr>
	<tr>    
	<td>Airport_Name</td><td><input type="text" name="Name" maxlength=30 required></td>
	</tr>
	<tr>    
	<td>City</td><td><input type="text" name="City" maxlength=20 required></td>
	</tr>
	<tr>
...
<h1>Edit Flight:</h1>
<br>
	<form method="post" action="Cust_Rep3b.jsp">
		<table>
	<tr>    
	
	<td>Airport_ID</td><td><input type="text" name="Airport_ID" maxlength=3 required></td>
	</tr>
...
<br>
	<form method="post" action="Cust_Rep3c.jsp">
		<table>
	<tr>    
