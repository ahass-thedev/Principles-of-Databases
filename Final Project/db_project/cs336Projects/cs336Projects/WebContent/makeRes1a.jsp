...
<%
	try{
		...
		String airCode = (String) request.getParameter("airID");
		String flight = (String) request.getParameter("flightID");
		String depDate = (String) request.getParameter("departDate");
...
<a href="res1.jsp"class="login100-form-btn wrap-input100 m-b-16"style="width:350px">Back</a>
</div>
</body>
</html>