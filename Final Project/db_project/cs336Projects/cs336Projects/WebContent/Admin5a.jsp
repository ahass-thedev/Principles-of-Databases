...
<%
	...
	List<String> list = new ArrayList<String>();
		...
		try {
			...
			str = "SELECT * FROM Leg L, Reservation R WHERE R.Res_No = L.Res_No AND L.Airline_ID = '" + airline + "' AND L.Flight_Number = '" + fno + "'";
			...
			result = stmt.executeQuery(str);
				if (!result.next() ) {
					...
					// Get Total Revenue
					String rev = "SELECT SUM(Booking_Fee) FROM Leg L, Reservation R WHERE R.Res_No = L.Res_No AND L.Airline_ID = '" + airline + "' AND L.Flight_Number = '" + fno + "'";
